...
class AgentTurnResultTest {
    ...
    void modelErrorRequiresModelErrorDetails() {
        TurnError error = new TurnError("provider timeout", TurnErrorSource.MODEL, true,
    ...
    void factoryRejectsMismatchedStopDetails() {
        TurnCancellation cancellation = new TurnCancellation(CancellationSource.USER,
                CancellationPhase.MODEL_REQUEST, "ctrl-c");

...
/**
 * Records when a large tool result was replaced with a shortened version
 * to stay within context budget. The original is stored on disk via {@code storageRef}.
 */
public record ToolResultReplacementRecord(String toolUseId, String toolName,
                                          ToolResultReplacementTrigger trigger,
                                          ToolResultStorageRef storageRef,
                                          String replacementContent,
                                          String preview, long originalChars, long previewChars,
                                          long replacementLength) {

    public ToolResultReplacementRecord(String toolUseId, String toolName,
                                       ToolResultReplacementTrigger trigger,
                                       ToolResultStorageRef storageRef,
                                       String replacementContent,
                                       long originalLength, long replacementLength) {
        this(toolUseId, toolName, trigger, storageRef, replacementContent, "",
                originalLength, 0, replacementLength);
    }
    ...
    public long originalLength() { return originalChars; }

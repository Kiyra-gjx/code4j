...
public record TuiInputEvent(Kind kind, Optional<Character> character, Optional<String> text) {
    ...
    public static TuiInputEvent pageUp() { return simple(Kind.PAGE_UP); }
    public static TuiInputEvent pageDown() { return simple(Kind.PAGE_DOWN); }
    public static TuiInputEvent scrollUp() { return simple(Kind.SCROLL_UP); }
    public static TuiInputEvent scrollDown() { return simple(Kind.SCROLL_DOWN); }
    public static TuiInputEvent cursorLeft() { return simple(Kind.CURSOR_LEFT); }
    public static TuiInputEvent cursorRight() { return simple(Kind.CURSOR_RIGHT); }

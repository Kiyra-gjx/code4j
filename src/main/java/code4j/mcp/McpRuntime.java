...
public final class McpRuntime implements AutoCloseable {
    ...
    public static McpRuntime empty() { return new McpRuntime(List.of(), List.of(), List.of()); }

    public List<Tool> tools() { return tools; }
    public List<McpServerSummary> summaries() { return summaries; }

    @Override public void close() { clients.forEach(McpClient::close); }
}
